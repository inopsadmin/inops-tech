...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/product/accessories", destination: "/biometric-devices", permanent: true },
      { source: "/product/accessories/:path*", destination: "/biometric-devices", permanent: true },
      { source: "/accessories", destination: "/biometric-devices", permanent: true },
