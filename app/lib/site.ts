...
export const DEFAULT_DESCRIPTION =
  "InOps Solutions delivers workforce management and authentication for industrial environments—biometrics, real-time tracking, and automated compliance for contract workers, attendance, payroll, access control, and visitor management. Based in Koramangala, Bengaluru.";
