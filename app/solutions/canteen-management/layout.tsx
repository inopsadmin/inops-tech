...
export const metadata: Metadata = routeMetadata({
  ...
  description:
    "Digital canteen and subsidy control — biometric meal counting, payroll-linked subsidies, inventory and waste tracking, contractor vs employee pricing. InOps, Bengaluru.",
