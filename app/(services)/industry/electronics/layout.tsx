...
const PAGE_TITLE = "Contract Labour Management for Electronics Manufacturing | InOps";
const PAGE_DESCRIPTION =
  "Precision Contract Labour Management for EMS and electronics manufacturing. InOps manages cleanroom access, contractor compliance, and high-volume seasonal hiring at scale.";
...
export const metadata: Metadata = routeMetadata({
  ...
  extraKeywords: [
    ...
    "EMS Contract Labour Management software",
...
const FAQ_ITEMS = [
  {
    question: "How does InOps handle cleanroom access enforcement?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes. InOps is built for rapid-scale onboarding — processing hundreds of contractors per day with automated BGV and zone clearance issuance.",
  },
  {
  ...
  {
    question: "Does InOps integrate with MES systems?",
    answer:
  ...
  {
    question: "How quickly can a new EMS facility go live on InOps?",
    answer:
