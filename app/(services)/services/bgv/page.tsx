...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes, as an industrial background verification company we run checks pan-India across identity, address, employment and education records.",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-[60px] max-w-[1240px] mx-auto relative z-[2]">
          ...
          <div>
            <div className="inline-flex items-center gap-[10px] text-[10.5px] tracking-[0.18em] uppercase text-white/[0.82] mb-7 font-semibold font-mono">
              ...
              SERVICE 01 / 05 &nbsp;·&nbsp; BACKGROUND VERIFICATION COMPANY
            </div>
            <h1 className="text-[clamp(32px,3.8vw,50px)] leading-[1.10] font-medium text-white tracking-[-0.02em] m-0">
              Verify every worker before they cross the gate.
            </h1>
            <p className="mt-[22px] text-[15px] leading-[1.7] text-white/[0.78] max-w-[500px]">
              InOps is a background verification company delivering employee background verification, contract worker verification, and industrial background verification for tier 1 factories, vendors, and industrial parks — deployed in days, not weeks.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              {[
                ...
                },
                {
                  ...
                  desc: "Connects directly into onboarding and HRMS workflows.",
              ...
              <div className="col-span-full border border-[#e6eaee] rounded-xl p-6 bg-white transition-all duration-200 hover:shadow-[0_16px_32px_rgba(11,30,45,0.08)] hover:-translate-y-[2px] hover:border-[#d7e2ea]">
                ...
                <div className="text-[14.5px] font-bold text-[#0b1e2d] mb-2">Pre-Employment Screening</div>
                <div className="text-[13px] leading-[1.6] text-[#6b7b8c]">Live check status visible to HR, security and procurement.</div>
              </div>
            </div>
          </div>
        </div>
