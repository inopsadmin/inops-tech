        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-[60px] max-w-[1240px] mx-auto relative z-[2]">
          ...
          <div>
            ...
            <p className="mt-[22px] text-[15px] leading-[1.7] text-white/[0.78] max-w-[500px]">
              InOps is a background verification delivering employee background verification, contract worker verification, and industrial background verification for tier 1 factories, vendors, and industrial parks — deployed in days, not weeks.
            </p>
