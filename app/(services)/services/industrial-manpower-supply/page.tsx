...
const faqs = [
  {
    q: "How fast can a new site be staffed?",
    a: "Typical industrial manpower supply timelines are significantly faster than traditional sourcing, since verification runs in parallel with sourcing.",
  },
  {
    q: "Does this replace our staffing vendor?",
    a: "It can run alongside or replace existing vendors, depending on your operating model.",
  },
  {
    q: "Is biometric enrollment done on our devices?",
    a: "Yes, enrollment is configured against your existing access and attendance infrastructure.",
  },
  {
    q: "What industries is this suited for?",
    a: "Manufacturing, logistics, warehousing and engineering operations with high-volume contract labour deployment needs.",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-[60px] max-w-[1240px] mx-auto relative z-[2]">
          ...
          <div>
            ...
            <div className="flex gap-[10px] mt-10 flex-wrap">
              <span className="text-xs text-white/[0.85] font-medium py-[7px] px-4 border border-white/35 rounded-full">Compliance Ready Workforce</span>
              <span className="text-xs text-white/[0.85] font-medium py-[7px] px-4 border border-white/35 rounded-full">Skilled Workforce Supply</span>
              <span className="text-xs text-white/[0.85] font-medium py-[7px] px-4 border border-white/35 rounded-full">Rapid Deployment</span>
            </div>
          </div>
          ...
          <div className="relative flex justify-center items-center min-h-[580px] mt-12 lg:mt-0">
            <div className="w-full max-w-[540px] bg-white/[0.08] backdrop-blur-xl border border-white/[0.18] rounded-3xl p-9 shadow-[0_30px_60px_rgba(4,20,36,0.35)]">
              ...
              <div className="text-[11px] tracking-[0.06em] uppercase text-white/55 mt-4 font-semibold">Workforce Supply · Operations Panel</div>
              ...
              <div className="flex flex-col gap-3 mb-2">
                {["BGV-cleared Workers", "Digital Onboarding", "Biometric Enrollment"].map((label) => (
            ...
            <div className="absolute bg-[#0b2438] text-white rounded-xl py-3 px-4 shadow-[0_20px_40px_rgba(4,20,36,0.4)] text-left" style={{ top: -14, right: -10 }}>
              <div className="text-[20px] font-bold leading-none">Pre-cleared</div>
              <div className="text-[11px] text-white/60 mt-1">Workforce</div>
            </div>
            <div className="absolute bg-[#0b2438] text-white rounded-xl py-3 px-4 shadow-[0_20px_40px_rgba(4,20,36,0.4)] text-left" style={{ bottom: -18, left: -18 }}>
              ...
              <div className="text-[11px] text-white/60 mt-1">Sourcing</div>
            </div>
            <div className="absolute bg-[#0b2438] text-white rounded-xl py-3 px-4 shadow-[0_20px_40px_rgba(4,20,36,0.4)] text-left" style={{ bottom: 40, right: -24 }}>
              <div className="text-[20px] font-bold leading-none">Day One</div>
              <div className="text-[11px] text-white/60 mt-1">Ready</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1.1fr_0.9fr] gap-[40px] items-end mb-[44px]">
            <div>
              ...
              <h2 className="text-[clamp(24px,3vw,32px)] leading-[1.25] font-bold text-[#0b1e2d] max-w-[480px]">
                What breaks today, before Workforce Supply is in place
              </h2>
            </div>
            ...
            {[
              {
                ...
                desc: "New sites wait weeks for compliant, verified workers.",
                icon: <><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></>,
              },
              {
                title: "Unverified Deployment",
                desc: "Workers reach site before background checks complete.",
                icon: <><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /></>,
              },
              {
                title: "Onboarding Friction",
                desc: "Biometric and attendance setup happens after workers arrive.",
                icon: <><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></>,
              },
              {
                title: "Statutory Exposure",
                desc: "Compliance gaps surface only after deployment.",
                icon: <><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" /><line x1="12" y1="9" x2="12" y2="13" /><line x1="12" y1="17" x2="12.01" y2="17" /></>,
              },
              {
                title: "Fragmented Sourcing",
                desc: "Multiple vendors, no consistent verification standard.",
                icon: <><polygon points="1 6 1 22 8 18 16 22 23 18 23 2 16 6 8 2 1 6" /><line x1="8" y1="2" x2="8" y2="18" /><line x1="16" y1="6" x2="16" y2="22" /></>,
              },
              {
                title: "Poor Ramp Visibility",
                desc: "No clear view of workforce readiness before go-live.",
      ...
      <section className="relative bg-[linear-gradient(135deg,#0d3a5c_0%,#14588c_60%,#1c7bb8_100%)] pt-[72px] px-[6vw] pb-[96px] overflow-hidden">
        ...
        <div className="max-w-[1240px] mx-auto relative z-[2]">
          ...
          <div className="relative grid grid-cols-2 md:grid-cols-4 gap-x-0 gap-y-10 items-start">
            ...
            {[
              { n: "01", label: "Source", desc: "Workers are sourced against the site's skill and scale needs.", icon: <><path d="M12 16V4M7 9l5-5 5 5" /><path d="M4 16v3a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-3" /></> },
              { n: "02", label: "Verify", desc: "Full background verification clears every worker in advance.", icon: <><path d="M4 8V5a1 1 0 0 1 1-1h3M4 16v3a1 1 0 0 0 1 1h3M20 8V5a1 1 0 0 0-1-1h-3M20 16v3a1 1 0 0 1-1 1h-3" /><circle cx="12" cy="12" r="3" /></> },
              { n: "03", label: "Onboard", desc: "Digital onboarding and biometric enrollment complete pre-deployment.", icon: <><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><path d="M14 2v6h6" /><path d="M9.5 15.5l2 2 3.5-4" /></> },
              { n: "04", label: "Deploy", desc: "A compliant, Day One-ready workforce reports on site.", icon: <><circle cx="12" cy="12" r="9" /><path d="M8.5 12.5l2.3 2.3L16 9.5" /></> },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.85fr_2fr] gap-5">
            ...
            <div className="relative rounded-[14px] bg-[linear-gradient(160deg,#1c7bb8_0%,#0d3a5c_120%)] pt-7 px-6 pb-7 flex flex-col justify-between min-h-[320px] overflow-hidden">
              ...
              <div className="relative z-[2]">
                ...
                <div className="text-[22px] font-extrabold text-white mb-2">BGV-cleared Workers</div>
                <div className="text-[13px] leading-[1.6] text-white/75">Every worker arrives already background-verified.</div>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              {[
                {
                  ...
                  desc: "Paperwork and documentation completed before Day One.",
                  icon: <><path d="M12 16V4M7 9l5-5 5 5" /><path d="M4 16v3a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-3" /></>,
                },
                {
                  title: "Biometric Enrollment",
                  desc: "Access and attendance devices pre-configured per worker.",
                ...
                {
                  title: "Skilled Workforce Matching",
                  desc: "Attendance systems ready the moment workers report.",
                  icon: <><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></>,
                },
                {
                  title: "Statutory Compliance",
                  desc: "Deployment aligned to contractor compliance obligations.",
                  icon: <><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /></>,
                },
              ].map(({ title, desc, icon }) => (
              ...
              <div className="col-span-full border border-[#e6eaee] rounded-xl p-6 bg-white transition-all duration-200 hover:shadow-[0_16px_32px_rgba(11,30,45,0.08)] hover:-translate-y-[2px] hover:border-[#d7e2ea]">
                ...
                <div className="text-[14.5px] font-bold text-[#0b1e2d] mb-2">Contract Labour Deployment</div>
                <div className="text-[13px] leading-[1.6] text-[#6b7b8c]">Verified workforce mobilised on accelerated timelines.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1240px] mx-auto relative z-[2]">
          <div className="grid grid-cols-1 md:grid-cols-[1.1fr_0.9fr] gap-[40px] items-end mb-[46px]">
            ...
            <p className="text-[13.5px] leading-[1.65] text-white/75 max-w-[340px] md:text-right md:justify-self-end">
              Outcomes reported by enterprises running Workforce Supply across their industrial and contract workforce operations.
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4">
            {[
              { val: "Pre-cleared", label: "100% Workforce" },
              { val: "80%", label: "Faster Ramp-up" },
              { val: "100%", label: "Digital Onboarding" },
              { val: "Day One", label: "Deployment Ready" },
            ].map(({ val, label }, i) => (
              <div key={label} className={`px-7 ${i === 0 ? "pl-0" : "border-l border-white/[0.22]"}`}>
                <div className="flex items-center gap-[6px] text-[clamp(20px,2.5vw,30px)] font-extrabold text-white mb-2">
        ...
        <div className="max-w-[1240px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[40px] items-start mb-[52px]">
            ...
            <p className="text-[14px] leading-[1.7] text-[#8696a7] max-w-[340px] md:text-right md:justify-self-end pt-2">
              A side-by-side view of how Workforce Supply changes day-to-day operations.
            </p>
          </div>
            ...
            <div className="bg-[#1362a8] rounded-2xl pt-9 px-9 pb-10 shadow-[0_24px_48px_rgba(11,30,45,0.20)]">
              ...
              <div className="flex flex-col">
                {[
                  ...
                  "One managed workflow, start to finish",
                ].map((item, i) => (
      ...
      <section className="bg-white pt-[80px] px-[6vw] pb-[100px] border-t border-[#eef1f4]">
        <div className="max-w-[1240px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-[0.85fr_1.15fr] gap-[80px] items-start">
            ...
            <div>
              ...
              <p className="text-[13.5px] leading-[1.65] text-[#6b7b8c] mb-7">
                Can&apos;t find what you&apos;re looking for? Our enterprise team can walk through Workforce Supply in the context of your sites.
              </p>
              <div className="bg-[#1362a8] rounded-[14px] pt-7 px-[26px] pb-[26px]">
                <div className="text-[15px] font-bold text-white mb-[10px]">Need workforce at short notice?</div>
                <div className="text-[13px] leading-[1.6] text-white/[0.72] mb-[18px]">
                  Our deployment team can scope an industrial manpower supply plan for your next site ramp-up.
                </div>
          ...
          <div className="border-t border-[#eef1f4] mt-12 pt-5 flex items-center gap-3 flex-wrap">
            ...
            {["Contract Workforce Supply", "Verified Contract Workers", "Factory Workforce Supply", "Industrial Staffing", "Contract Labour Deployment"].map((tag) => (
