            ...
            <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-[10px]">
              ...
              <div>
                ...
                <div className="flex justify-between mt-[3px]">
                  ...
                  <span className={`text-[10.5px] ml-auto ${fields.message.trim().length < 10 && touched.message ? "text-red-400" : "text-[#aab4bf]"}`}>
              ...
              <button type="submit" disabled={submitting}
                ...
                {submitting ? (
                  ...
                  <>Send <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M13 5l7 7-7 7" /></svg></>
                )}
              </button>

              {/* Divider */}
              <div className="flex items-center gap-2 my-[2px]">
                <span className="flex-1 h-px bg-[#e2e8ee]" />
                <span className="text-[10.5px] text-[#aab4bf] font-medium">or</span>
                <span className="flex-1 h-px bg-[#e2e8ee]" />
              </div>
              ...
              <a
                ...
                className="w-full py-[10px] rounded-lg text-[13px] font-bold text-white bg-[#25D366] hover:bg-[#20c05a] transition-colors duration-150 flex items-center justify-center gap-2"
              >
                <svg width="17" height="17" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
