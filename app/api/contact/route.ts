...
// Destination inbox — set CONTACT_TO_EMAIL in .env
const TO = process.env.CONTACT_TO_EMAIL ?? "soragavivinayak@gmail.com";

// "From" must be a verified domain in your Resend account.
// During development you can use:  onboarding@resend.dev  (sends only to your own email)
const FROM = "InOps Contact <onboarding@resend.dev>";
